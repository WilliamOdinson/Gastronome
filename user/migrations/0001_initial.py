    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.CharField(max_length=22, primary_key=True, serialize=False, unique=True, verbose_name='Yelp User ID')),
                ('display_name', models.CharField(max_length=150, verbose_name='Display Name')),
                ('email', models.EmailField(blank=True, max_length=254, null=True, unique=True, verbose_name="User's Email")),
                ('yelping_since', models.DateField(blank=True, null=True, verbose_name='Years Since Registration')),
                ...
                ('friends', models.JSONField(blank=True, default=list, verbose_name='Friend List')),
                ('elite_years', models.JSONField(blank=True, default=list, verbose_name='Elite Years')),
            ...
            options={
                'indexes': [models.Index(fields=['review_count'], name='user_user_review__3b8c2d_idx'), models.Index(fields=['fans'], name='user_user_fans_1ca852_idx')],
            },
            managers=[
