...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['review_count'], name='user_user_review__3b8c2d_idx'),
        ),
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['fans'], name='user_user_fans_1ca852_idx'),
        ),
        migrations.AddIndex(
            model_name='friendship',
            index=models.Index(fields=['user', 'friend'], name='user_friend_user_id_c4dfc0_idx'),
        ),
        migrations.AddIndex(
            model_name='friendship',
            index=models.Index(fields=['friend'], name='user_friend_friend__350dcf_idx'),
        ),
