...
echo ">>> Importing business data, 150,346 entires (~5 min for batch = 1,000)"
python manage.py import_business "$DATA_DIR/yelp_academic_dataset_business.json"

echo ">>> Importing hour data, 150,346 entires (~5 min for batch = 5,000)"
python manage.py import_hour "$DATA_DIR/yelp_academic_dataset_business.json"

echo ">>> Importing user data, 1,987,897 entires (~10 min for batch = 2,500)"
python manage.py import_user "$DATA_DIR/yelp_academic_dataset_user.json"

echo ">>> Importing user's email data, 1,987,897 entires (~30 min for batch = 10,000)"
...
echo ">>> Importing checkin data, 131,930 entires (~15 min for batch = 5,000)"
...
echo ">>> Importing reviews, 6,990,280 entires (~40 min for batch = 5,000)"
